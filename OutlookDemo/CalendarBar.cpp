...
void CCalendarBar::OnPaint() {
  ...
  if (rectClient.bottom - m_nMyCalendarsY > 0) {
    ...
    rectMyCalendarsCaption.bottom = rectMyCalendarsCaption.top + globalData.GetTextHeight(TRUE) * 3 / 2;
    ...
    rectCalendar.bottom = rectCalendar.top + globalData.GetTextHeight(TRUE) * 3 / 2 - 5;
    ...
    dc.SetTextColor(globalData.clrHotLinkNormalText);
