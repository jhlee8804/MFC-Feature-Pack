...
BOOL CPage5::OnInitDialog()
{
	...
	pGroup1->AddSubItem(new CMFCPropertyGridProperty(_T("3D Look"), (COleVariant)VARIANT_FALSE, _T("Specifies the dialog's font will be nonbold and controls will have a 3D border")));
	...
	pProp = new CMFCPropertyGridProperty(_T("Height"), (COleVariant) 250l, _T("Specifies the dialog's height"));
	pProp->EnableSpinControl(TRUE, 0, 1000);
	pSize->AddSubItem(pProp);

	pProp = new CMFCPropertyGridProperty( _T("Width"), (COleVariant) 150l, _T("Specifies the dialog's width"));
