...
void CMainFrame::AddMainCategory()
{
	...
	pBtnPrepare->AddSubItem(new CMFCRibbonButton(ID_FILE_PREPARE_RUN_CHECKER, _T("Run &Compatibility Checker"), 20, 20, TRUE));
...
void CMainFrame::AddTab_Home()
{
	...
	pStyleBtn->AddSubItem(new CMFCRibbonButton(ID_WRITE_CLEARFORMATING, _T("&Clear Formating"), 8, -1));
	...
	pCategory->AddHidden(new CMFCRibbonButton(ID_BORDERS_DIAGONALDOWNBORDER, _T("Diagonal &Down Border"), 26));
...
void CMainFrame::AddTab_References()
{
	...
	CMFCRibbonButton* pBtn = new CMFCRibbonButton(ID_TABLE_OF_CONTEXT, _T("Table of Contents\nt"), 12, 0);
...
void CMainFrame::AddTab_Review()
{
	...
	CMFCRibbonPanel* pPanelProofing = pCategory->AddPanel(_T("Proofing"), m_PanelImages.ExtractIcon(29));

	pPanelProofing->Add(new CMFCRibbonButton(ID_REVIEW_PROOFING_SPEELINGGRAMMAR, _T("Spelling && Grammar\ns"), 0, 0));
	...
	CMFCRibbonPanel* pPanelComments = pCategory->AddPanel(_T("Comments"), m_PanelImages.ExtractIcon(30));
	...
	CMFCRibbonPanel* pPanelTracking = pCategory->AddPanel(_T("Tracking"), m_PanelImages.ExtractIcon(31));
	...
	CMFCRibbonPanel* pPanelChanges = pCategory->AddPanel(_T("Changes"), m_PanelImages.ExtractIcon(32));
	...
	CMFCRibbonPanel* pPanelCompare = pCategory->AddPanel(_T("Compare"), m_PanelImages.ExtractIcon(33));
	...
	CMFCRibbonPanel* pPanelProtect = pCategory->AddPanel(_T("Protect"), m_PanelImages.ExtractIcon(34));

	pPanelProtect->Add(new CMFCRibbonButton(ID_REVIEW_PROTECT, _T("Protect Document\npr"), 22, 14));

	pCategory->AddHidden(new CMFCRibbonButton(ID_REVIEW_TRACKING_REVIEWINGPANE_VERTICAL, _T("Reviewing Pane Vertical"), 15));
	pCategory->AddHidden(new CMFCRibbonButton(ID_REVIEW_TRACKING_REVIEWINGPANE_HORIZONTAL, _T("Reviewing Pane Horizontal"), 23));
	pCategory->AddHidden(new CMFCRibbonButton(ID_REVIEW_CHANGES_ACCEPT_CHANGE, _T("Accept Change"), 16));
	pCategory->AddHidden(new CMFCRibbonButton(ID_REVIEW_CHANGES_REJECT_CHANGE, _T("Reject Change"), 17));

	pCategory->AddHidden(new CMFCRibbonButton(ID_REVIEW_COMPARE_COMPARE_COMPARE, _T("Compare"), 24));
	pCategory->AddHidden(new CMFCRibbonButton(ID_REVIEW_COMPARE_COMPARE_COMBINE, _T("Combine"), 25));
}
